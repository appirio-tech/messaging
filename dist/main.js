...
angular.module("appirio-tech-messaging").run(["$templateCache", function($templateCache) {$templateCache.put("views/messaging.html","<h1>Messaging</h1><hr/><messaging thread-id=\"123\" created-by=\"abc\"></messaging>");
